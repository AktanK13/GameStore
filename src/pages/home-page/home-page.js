...
const GAMES = [
    ...
    {
        image: 'https://upload.wikimedia.org/wikipedia/ru/b/bd/The_Last_of_Us_Cover.jpg',
        title: 'The Last of Us Part I',
        genres: ['Экшен', 'Открытый мир'],
        video: 'https://www.youtube.com/embed/n4BotYGLXeg',
        price: 4999,
        id: 7,
        description: 'Лучшая игра поколения, обновленная для PS4 Во враждебном, опустошенном эпидемией мире Джоэл и Элли, которых трагическая судьба свела вместе, могут полагаться только друг на друга, чтобы пережить полное опасностей путешествие по территории бывших Соединенных Штатов.'
    },
    {
        image: 'https://upload.wikimedia.org/wikipedia/ru/thumb/f/f1/The_last_of_us_2_cover.png/274px-The_last_of_us_2_cover.png',
        title: 'The Last of Us Part I',
        genres: ['Экшен', 'Открытый мир'],
        video: 'https://www.youtube.com/embed/btmN-bWwv0A',
        price: 4999,
        id: 8,
        description: 'The Last of Us Part II (букв. с англ. — «Последние из нас: Часть 2», в России издаётся под названием «Одни из нас: Часть II») — компьютерная игра в жанре приключенческого боевика с элементами survival horror и стелс-экшена от третьего лица, разработанная компанией Naughty Dog и изданная Sony Interactive Entertainment в 2020 году для игровой приставки PlayStation 4. Является прямым сюжетным продолжением игры The Last of Us.'
    },
]
